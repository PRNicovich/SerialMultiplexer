...
//#define SWITCHING_EXTRUDER
  ...
  #define SWITCHING_EXTRUDER_SERVO_ANGLES { 0, 180 } // Angles for E0, E1
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 410 // calibrated with finding endstops on x axis.  Actual 407.92
#define Y_MAX_POS 65 // calibrated with finding endstops on y axis. Actual 63.31
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,100,100,100}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {1000, 1000, 1000, 1000, 1000}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3000,3000,3000,3000,3000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
